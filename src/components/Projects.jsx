...
const projects = [
  ...
  },
  {
    ...
    description: 'Cinematic video campaign for urban streetwear brand featuring dynamic editing and color grading.',
  ...
  },
  {
    ...
    description: 'Animated showreel featuring dynamic typography, logo animations, and visual effects.',
  ...
  },
  {
    ...
    description: 'Clean, modern magazine design with emphasis on typography and white space.',
    image: 'https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=800&h=600&fit=crop',
    category: 'print',
    type: 'Print Design',
    client: 'Artisan Magazine',
    link: '#',
    featured: false,
    isExternal: false,
  },
  {
    ...
    description: 'High-energy product launch video with 3D elements and dynamic transitions.',
  ...
  },
  {
    ...
    description: 'Comprehensive social media design kit with templates for Instagram, TikTok, and YouTube.',
    image: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=800&h=600&fit=crop',
    category: 'branding',
    type: 'Social Media',
    client: 'Influencer Hub',
    link: '#',
    featured: false,
    isExternal: false,
  },
  {
    ...
    description: 'Series of animated logo reveals and intros for various clients.',
  ...
  },
  {
    ...
    description: 'Feature-length documentary editing with narrative storytelling and emotional pacing.',
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative py-24 overflow-hidden creative-bg">
      {/* Background */}
